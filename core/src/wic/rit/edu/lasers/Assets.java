...
import wic.rit.edu.lasers.functional.FloatConsumer;
import wic.rit.edu.lasers.math.ByteMath;
...
public final class Assets {
	 ...
	 *
	 * @param initialAssets Initial assets to load
	 ...
	 * @param descriptors List of {@link AssetDescriptor descriptors} to load
	 ...
	 *
	 * @param manager Asset Manager to unload assets from
	 * @param assets  A List of paths of the assets to unload
	 ...
	 *
	 * @param t Base texture
	 * @param n	Number of frames to grab
	 * @param r Row to start on
	 * @param c Column to start on
	 * @param width Width of each frame
	 * @param height Height of each frame
	 * @param frameTransform Function that takes a TextureRegion and creates a transformed version
     *
	 * @return Animation strip with n frames
	 * @exception IllegalStateException if n frames could not be grabbed
     */
	 ...
	 *
	 * @param hex Hex code for RGB color
	 ...
	 * Given a hexcode as a string, returns the appropriate LibGDX Color.
	 *
	 * @param hexa Hex code for RGBA color
	 ...
	 *
	 * @param hex 24-bit rgb or 32-bit rgba bit pattern
	 * @return LibGDX Color
     */
	 ...
	 * is left unchanged.
	 *
	 * @param hex 24-bit bit pattern for RGB color
	 * @param alpha Alpha value between 0 and 1
     * @return LibGDX Color
     */
