...
public final class ComponentMappers extends UtilitiesClass {
	...
	public static final ComponentMapper<TextureComponent> TEX_MAPPER = ComponentMapper
	...
	public static final ComponentMapper<StateComponent> STATE_MAPPER = ComponentMapper
		.getFor(StateComponent.class);
	public static final ComponentMapper<AnimationComponent> ANIM_MAPPER =
		ComponentMapper.getFor(AnimationComponent.class);
	public static final ComponentMapper<BackgroundComponent> BG_MAPPER = ComponentMapper
