...
/**
 * <p> An enumeration of all available {@link Asset assets} with known paths, {@link Class classes}, and {@link
 * AssetType types}. </p> <p> <p> Assets instances can be loaded and gotten using a provided {@link AssetManager}, the
 * path is already resolved using {@link InternalFileHandleResolver} or a provided {@link FileHandleResolver}. </p>
 *
...
public enum Assets implements Asset {
	...
	FNT_CONTINUUM_GENERATOR("fonts/contb.ttf", FreeTypeFontGenerator.class, FONT_GENERATOR),
	...
	/**
	 * Creates an {@link Assets} instance with all the information necessary to be an {@link Asset} instance as well.
	 * The path is resolved to a {@link FileHandle} using the provided {@link FileHandleResolver}.
	 *
	 * @param path
	 * 	Path relative to the android <tt>res</tt> directory that can be used to retrieve asset
	 * @param assetClass
	 * 	{@link Class} representing the type of asset ({@link Texture Texture.class}, {@link BitmapFont
	 * 	BitmapFont.class}, etc.
	 * @param parameters
	 * 	{@link AssetLoaderParameters Parameters} for the {@link com.badlogic.gdx.assets.loaders.AssetLoader loader}
	 * 	when
	 * 	loading asset.
	 * @param type
	 * 	{@link AssetType} instance most closely representing this Asset's usage
	 * @param resolver
	 * 	{@link FileHandleResolver} to be used to resolve the path provided by the descriptor, to a file.
	 * @param <T>
	...
	<T> Assets(AssetDescriptor<T> descriptor, AssetType type, FileHandleResolver resolver) {
		this.handle = descriptor.file == null ? resolver.resolve(descriptor.fileName) : descriptor.file;
	...
	/**
	 * Returns an {@link ImmutableObjectSet} representing all {@link Asset assets} known to this class.
	 *
	 * @param type
	...
	/**
	 * Returns an {@link ImmutableObjectSet} of all {@link Asset assets}, known to this class, which have an {@link
	 * Class asset class} equal to the supplied asset class. Subclasses are not included.
	 *
	 * @param assetClass
	 * 	{@link Class} to filter for
	 *
	 * @return {@link ImmutableObjectSet} of assets whose asset class matches the given asset class, not including
	 * subclasses.
	 */
	...
	/**
	 * Returns an {@link ImmutableObjectSet} of all {@link Asset assets}, known to this class, which have an {@link
	 * Class asset class} equal to the supplied asset class. If <tt>subclasses</tt> is true, the set will also consist
	 * of all Assets whose asset class is a subclass of the given asset class.
	 *
	 * @param assetClass
	 * 	{@link Class} to filter for
	 * @param subclasses
	 ...
	 *
	 * @return {@link ImmutableObjectSet} of assets whose asset class matches the given asset class, optionally
	 * including subclasses.
	 */
	public static ImmutableObjectSet<Asset> getAssetsOfClass(Class<?> assetClass, boolean subclasses) {
