...
/**
 * <p>
 * A logging system inspired by Timber (Created by Jake Wharton). Following the same
 * theme of not being directly named, a Beam (Laser Beam) that is made up of many
 * {@link LightRay light rays}.
 * </p>
 * <p>
 * Following the idiomatic Java Singleton structure, this is an enum with a single
 * instance representing the one-and-only instance of this class. A LightRay can do
 * anything from logging per-platform to logging out to an external service or file,
 * all {@link Beam} does is send out logging actions to all {@link LightRay} instances
 * registered.
 * </p>
 *
...
public enum Beam {
	...
	/**
	 * Adds a {@link LightRay} to the beam. Any logging actions will be sent to the ray
	 * as well.
	 *
	 * @param ray {@link LightRay} to add
	 * @throws NullPointerException Parameter is null
	 * @throws IllegalArgumentException Parameter is Root LightRay
	 */
	 ...
	 * the rays as well.
	 *
	 * @param rays All {@link LightRay LightRays} to add
	 * @throws NullPointerException Any {@link LightRay} in parameter is null
	 * @throws IllegalArgumentException Any {@link LightRay} in parameter is Root LightRay
	 */
	...
	/**
	 * Removes a {@link LightRay} from the beam. No more logging actions will be sent
	 * to that LightRay from this Beam.
	 *
	 * @param ray {@link LightRay} to remove
	 * @throws NullPointerException Parameter is null
	 * @throws IllegalArgumentException LightRay has not been added
	 */
	 ...
	 * this {@link Beam}. Should only be iterated over, modify LightRay instances at
	 * your own risk.
	 *
	 * @return {@link ImmutableArray} of {@link LightRay LightRays} known by this
	 * {@link Beam}
	 */
	...
	/**
	 * Root {@link LightRay} instance of the logging tree. Logging actions are emitted
