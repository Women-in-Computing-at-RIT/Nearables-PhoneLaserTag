...
/**
 * {@link IteratingSystem} to render background {@link Entity entities}. That is those with a {@link TransformComponent}
 * and {@link BackgroundComponent}. The primary benefit is that the transform's z-value (depth) is ignored and the
 * entity is forced to the back and follows the camera.
 *
