...
/**
 * {@link IteratingSystem} to handle {@link Entity entities} that have state. The system handles updating stateful time.
 * Potentially, the system can also handle State Machine transitions. Thus the entities require {@link StateComponent}.
 *
