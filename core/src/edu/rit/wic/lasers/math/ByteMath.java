...
public final class ByteMath extends UtilitiesClass {
	...
	/**
	 * Get the nth byte in a long integer value. This can also be used for floating
	 * point numbers using {@link Float#floatToIntBits(float)} and
	 ...
	 * @throws IllegalArgumentException if n >= 8 since maximum bit pattern size is 64
	 * bits
	 */
	...
	/**
	 * Get the nth short integer (group of 2 bytes) in a long integer value. This can also
	 ...
	 * @throws IllegalArgumentException if n >= 4 since maximum bit pattern size is 64
	 * bits
	 */
	...
	/**
	 * Get the nth integer (group of 4 bytes) in a long integer value. This can also
	 * be used for floating point numbers using {@link Float#floatToIntBits(float)} and
	 * {@link Double#doubleToLongBits(double)}.
	 *
	 * @param value
	 ...
	 * @throws IllegalArgumentException if n >= 2 since maximum bit pattern size is 64
	 * bits
	 */
	...
	/**
	 * <p>
	 * Create a long from two integer values. This is evaluated as:
	 * </p>
	 * <tt>value = (upper << 32) | lower</tt>
	 *
	 *
	 * @param upper
	 *  Upper 32 bit value
