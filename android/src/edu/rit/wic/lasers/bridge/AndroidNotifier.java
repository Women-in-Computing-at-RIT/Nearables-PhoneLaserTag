...
/**
 * Android implementation of {@link Notifier} which uses {@link TastyToast} to show various sweet Toast notifications.
 * This is executed on the UI Thread and may not be executed immediately... but should be executed pretty quickly!
 *
...
public class AndroidNotifier extends AbstractNotifier {
	...
	@Override
	public void msg(final DurationHint duration, final NotifType type, final String message, final Object... args) {

		Context ctxt = this.notifierContext;
		String msg = String.format(message, args);
		this.notifierContext.runOnUiThread(() -> TastyToast.makeText(ctxt, msg, translateDuration(duration),
			translateType(type)));
